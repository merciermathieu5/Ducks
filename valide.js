/* Harnais de validation — Ducks d’Anaheim (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'ANAHEIM',
  taille: 25,
  echantillon: {nom: 'Ethan Phillips', salaire: 750000, ct: 0, ov: 77},
  masseSousContrat: 62957000,
  nbSousContrat: 13,
  dateSecours: '8 juillet 2026',
  nbEchus: 12,
  nbBackups: 0,
  masseTotale: 97282000
};
...
(async () => {
  ...
  W.localStorage.removeItem('ana_resignatures_v1');
  W.localStorage.removeItem('ana_transac_v1');
